    ...
    return {
        ...
        "/practice/": [
            ...
            },
            {
                ...
                base: "/practice/2025/",
                items: [
                    {text: "大富翁导论", link: "01.md"},
                    {text: "知行合一操盘系统", link: "02.md"},
        ...
        "/other/": [
            ...
            },
            {
                ...
                base: "/other/blog/",
                items: [
                    {text: "VitePress初始化", link: "01.md"},
                    {text: "代码托管至Github", link: "02.md"},
                    {text: "Vercel部署博客", link: "03.md"},
                    {text: "引入GitTalk功能", link: "04.md"},
                    {text: "引入阅读时间和字数组件", link: "05.md"},
                ],
                collapsed: true,
            },
        ],
